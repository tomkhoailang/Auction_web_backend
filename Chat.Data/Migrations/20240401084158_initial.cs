    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatRoomProducts", x => x.ChatRoomProductId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInStatuses", x => x.ProductInStatusID);
                    table.ForeignKey(
                        name: "FK_ProductInStatuses_ProductStatuses_ProductStatusId",
                        column: x => x.ProductStatusId,
                        principalTable: "ProductStatuses",
                        principalColumn: "ProductStatusId");
                    table.ForeignKey(
                        name: "FK_ProductInStatuses_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInStatuses_ProductId",
                table: "ProductInStatuses",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInStatuses_ProductStatusId",
                table: "ProductInStatuses",
