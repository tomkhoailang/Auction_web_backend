...
namespace Chat.Service.Services
{
    public interface IProductManagement
    {
        ...
        public Task<ApiResponse<Product>> AssignToChatRoomAsync(List<Product> products, ChatRoom chatRoom, int duration);
        ...
        public Task<ApiResponse<List<BiddingFare>>> GetListBiddingFares();
